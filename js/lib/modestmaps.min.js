...
(function (MM) {
    ...
    MM._browser = function (window) {
        return {webkit: "WebKitCSSMatrix"in window, webkit3d: "WebKitCSSMatrix"in window && "m11"in new WebKitCSSMatrix}
    }(this);
    ...
    MM.MapProvider.prototype = {
        ...
        sourceCoordinate: function (coord) {
            var TL = this.tileLimits[0].zoomTo(coord.zoom).container(), BR = this.tileLimits[1].zoomTo(coord.zoom), columnSize = Math.pow(2, coord.zoom), wrappedColumn;
    ...
    MM.TouchHandler = function () {
        var handler = {id: "TouchHandler"}, map, maxTapTime = 250, maxTapDistance = 30, maxDoubleTapDelay = 350, locations = {}, taps = [], snapToZoom = true, wasPinching = false, lastPinchCenter = null;
        ...
        function touchEnd(e) {
            ...
            for (var i = 0; i < e.changedTouches.length; i += 1) {
                ...
                var pos = {
                    x: t.clientX,
                    y: t.clientY
                }, time = now - loc.time, travel = MM.Point.distance(pos, loc.startPos);
        ...
        function onPinching(e) {
            var t0 = e.touches[0], t1 = e.touches[1], p0 = new MM.Point(t0.clientX, t0.clientY), p1 = new MM.Point(t1.clientX, t1.clientY), l0 = locations[t0.identifier], l1 = locations[t1.identifier];
            l0.wasPinch = true;
            l1.wasPinch = true;
